package com.school.driving.common.mybatisGenerator.plugin;
...
//		String config = MysqlPagePlugin.classs.getClassLoader().getResource("generatorConfig-w5Log.mapper").getFile();
